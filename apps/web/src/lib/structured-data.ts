...
/**
 * Get default organization schema for Projects app
 */
export function getProjectsOrganizationSchema(): OrganizationSchema {
  return {
    name: 'Projects Management',
    url: import.meta.env.VITE_PUBLIC_SITE_URL || 'https://projects.your-domain.com',
    description: 'Project management platform for teams to collaborate and deliver projects on time.',
  }
}
